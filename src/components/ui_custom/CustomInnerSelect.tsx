...
interface CustomInnerSelectProps {
  value: string | null;
...
export const CustomInnerSelect: FC<CustomInnerSelectProps> = ({
  value,
  onValueChange,
  options,
  placeholder,
  ...
  return (
    <Select.Root value={value || ''} onValueChange={handleValueChange} disabled={disabled}>
      <Select.Trigger
        className={cn(
          "flex h-9 w-full items-center justify-between bg-background px-2.5 py-1.5 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
